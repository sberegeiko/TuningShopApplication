    ...
    <div class="row">
        <div class="nav col-sm-3 col-md-2 list-group">
            <c:forEach var="catalog" items="${catalogList}">
                <a href="sselectedByCatalogAndCar.do?catalogId=${catalog.id}&carId=${selectedCar.id}" class="list-group-item">${catalog.name}</a>
            </c:forEach>
        </div>
        ...
        <div class="col-sm-9 col-md-10 main">
            ...
            <div class="btn-group" role="group">
                ...
                <a class="btn btn-default" href="selectedByCatalogAndCar.do?carId=${selectedCar.id}&catalogId="> Show all products for this
                    car</a>
            </div>
